...
export async function saveAllPyFilesToDisk() {
...
export function initReadedConf(conf, filePath, configProjectPath = '') {
  document.main.initUIConf(conf, filePath, configProjectPath);
}
...
export function getConfParamValue(paramName, def = '') {
  let paramValue = document.main.conf.ClientConfiguration[paramName]
